      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          ...
          <div class="col-md-7 text-center">
            <p>We deliver clean, professional and excellent quality services. The right mix for the right purpose.</p>
          </div>
        </div>
          ...
          <div class="col-lg-6">
            <div class="row no-gutters align-items-stretch h-100 half-sm">
              ...
              <div class="col-md-6 bg-light text">
                <div class="p-4">
                  <h2 class="h5 mb-3 text-black line-height-sm">Consulting (market and business development) </h2>
                  <p>We help companies grow by increasing the creative capital in their brands and businesses, with an obsession for real-world results.</p>
            ...
            <div class="row no-gutters align-items-stretch h-100 half-sm">
              ...
              <div class="col-md-6 bg-light text order-md-1 order-lg-2">
                <div class="p-4">
                  ...
                  <p>we offer highly-specialized electromechanical design and analysis services for a sure-fire solution in rugged electronics. Put your trust in our expertise! With our carefully-designed products and systems, your hardware will be fully ready to operate in the most rugged environments.</p>
                  <p class="mb-0"><a href="#" class=""><small class="text-uppercase font-weight-bold text-black">Read More</small></a></p>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-6">
            <div class="row no-gutters align-items-stretch h-100 half-sm">
              ...
              <div class="col-md-6 bg-light text order-md-1">
                <div class="p-4">
                  <h2 class="h5 mb-3 text-black line-height-sm">Procurement and supplies</h2>
                  <p>includes sourcing, obtaining and paying for goods and services. Supply chain management also covers the logistics involved in obtaining goods, such as shipping and warehouse management, as well as transforming the procured goods into products and distributing them to customers.</p>
                  <p class="mb-0"><a href="#" class=""><small class="text-uppercase font-weight-bold text-black">Read More</small></a></p>
                </div>
              </div>
            </div>
