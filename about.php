      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 pr-md-5 text-left mb-5">
            <div>
              <img src="images/babatunde.jpeg" alt="Image" class="w-50 mb-5 rounded">
              <h2>Babatunde Baba-Agba</h2>
              <h3>Head, Business Stakeholder Management</h3>
              <p class="lead">
              Babatunde is experienced in providing management oversight for the development of high quality, cost-effective, and integrated marketing programs for gas distribution.

              He joined Gaslink Nigeria Limited, a subsidiary of Axxela Limited, in 2000 as Project Accountant where he was responsible for the day-to-day management of project cost and administration. In 2003, he became Head, Procurement and Supplies and was responsible for the procurement of project materials for the Greater Lagos Gas Distribution Project 1A and 1B. Before joining Gaslink, he worked at Ibru Organization and Aquamarine Finance & Securities Limited.

              Babatunde holds an MSc. in Financial Management from University of Ibadan. He is also a Chartered Professional in Industrial Gas Marketing from the Gas Technology Institute, Chicago, USA.
              </p>
